    ...
    <section id="como-funciona" className="py-20 md:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-sm text-textSecondary/70 max-w-3xl mx-auto italic">
            {copy.timeline.microcopy}
          </p>
        </motion.div>

        <div className="relative">
          <div className="absolute left-0 right-0 mx-auto top-8 md:top-10 h-px bg-stroke" />
            ...
            {timelineSteps.map((step, index) => (
              ...
              >
                <div className="relative mb-4">
                  <div className={`flex items-center justify-center w-16 h-16 rounded-full border-2 border-accent/40 bg-background shadow-[0_0_30px_0_rgba(255,45,45,0.35)] transition-all duration-300 transform will-change-transform group-hover:scale-105`}>
                ...
                <h3 className="text-xl md:text-2xl font-bold text-textPrimary mb-2 tracking-tight">
                  {step.title}
                </h3>
        ...
        >
          <div className={`inline-flex items-center space-x-2 bg-${styles?.accentColor || 'accent'}/10 border border-${styles?.accentColor || 'accent'}/20 rounded-lg px-6 py-3`}>
            ...
            <span className="text-textPrimary font-medium">Entrega garantida em 72 horas ou seu dinheiro de volta</span>
          </div>
        </motion.div>
      </div>
    </section>
